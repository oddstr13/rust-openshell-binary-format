...
impl Display for Error {
	fn fmt(&self, formatter: &mut fmt::Formatter) -> fmt::Result {
		match self {
			...
			Error::TooLarge => formatter.write_str("input data too large"),
			/* and so forth */
			...
			Error::ExpectedMapValue => formatter.write_str("expected map value"),
			Error::ExpectedSequenceEnd => formatter.write_str("expected end of sequence"),
			Error::TrailingCharacters => formatter.write_str("too much data"),
